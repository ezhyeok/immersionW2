...
import com.example.tab3.MapViewFragment2.Companion.STORE_ITEM
...
class MapShowActivity : BaseActivity<ActivityMapBinding, MapViewModel>(R.layout.activity_map), OnMeterSetListener , OnMapReadyCallback{
    ...
    private val mapViewFragment = MapViewFragment2()
    ...
    companion object {
        ...
        fun newInstance(context: Context, profileItem: List<StoreItem>): Intent {
            return Intent(context, MapShowActivity::class.java).apply {
                putParcelableArrayListExtra(ARG_PARAM, ArrayList(profileItem))
            }
        }
    }
            ...
            if(storeList!=null) {
                ...
                viewModel.surroundStoreListLiveData.observe(this) { response ->
                    ...
                    supportFragmentManager.beginTransaction()
                        .add(R.id.fragment_map, mapViewFragment).commit()
                }
            }
        }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val storeItems = intent.getParcelableArrayListExtra<StoreItem>(ARG_PARAM)
        if (storeItems != null) {
            storeList = StoreList2(storeItems)
        }
        Log.d("SSStoreList", "$storeList")
        /*
